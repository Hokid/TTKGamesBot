					...
					if(xhr.status == 200) {
						...
						if(context.toggle_check_arr){
							...
							if(window.img_code[window.img_code.length-1].indexOf(req_id) == -1){
								...
								$("#el_img").html('<img src="/BigGameTTK2015/cache_code/'+req_id+'.png" width="570" height="80" alt="" />');
...
<div id="fix_wrap">\
	<div id="center_wrap">\
		...
		<audio id="el_audio" src="http://cs4-1v4.vk-cdn.net/p24/c3cdaee2b6b34b.mp3" controls></audio>\
	</div>\
</div>';
